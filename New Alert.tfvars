...
nrql_alert_condition_details_mssql = {
  "0" = {
    ...
    query                           = "FROM MssqlCustomQuerySample  SELECT uniqueCount(AverageWaitTimeMs) WHERE label.query='avgwait'  AND AverageWaitTimeMs >250 AND instance LIKE '%prd%' FACET wait_type, instance,hostname,AverageWaitTimeMs"
    warning                         = false
    critical                        = true
  ...
  "1" = {
    ...
    aggregation_delay             = 120
    baseline_direction            = "upper_only"
    query                         = "FROM MssqlCustomQuerySample  SELECT uniqueCount(vlf_count) WHERE label.query='virfile' WHERE vlf_count IS NOT NULL AND vlf_count >100  AND instance LIKE '%prd%' FACET vlf_count,instance,hostname,name"
    warning                       = true
    critical                      = false
  ...
  "2" = {
    type                            = "static"
    account_id                      = 2947933
    name                            = "vlf count (more than thousand)"
    description                     = ""
    runbook_url                     = "https://www.example.com"
    enabled                         = false
    violation_time_limit_seconds    = 3600
    ...
    aggregation_delay               = 120
    baseline_direction              = "upper_only"
    query                           = "FROM MssqlCustomQuerySample  SELECT uniqueCount(vlf_count) WHERE label.query='virfile' WHERE vlf_count IS NOT NULL AND vlf_count >1000  AND instance LIKE '%prd%' FACET vlf_count,instance,hostname,name"
    warning                         = false
    critical                        = true
    critical_operator               = "above_or_equals"
    critical_threshold              = 1
  ...
  "3" = {
    ...
    aggregation_delay             = 120
    baseline_direction            = "upper_only"
    query                         = "FROM MssqlCustomQuerySample SELECT uniqueCount(HoursSinceLastBackup) WHERE label.query='avbackup' WHERE HoursSinceLastBackup >=24 AND HoursSinceLastBackup <=36   AND instance LIKE '%prd%' FACET instance,HoursSinceLastBackup,hostname"
    warning                       = true
    critical                      = false
    warning_operator              = "above_or_equals"
    warning_threshold             = 1
  ...
  "4" = {
    ...
    aggregation_delay               = 120
    baseline_direction              = "upper_only"
    query                           = "FROM MssqlCustomQuerySample SELECT uniqueCount(HoursSinceLastBackup) WHERE label.query='avbackup' WHERE HoursSinceLastBackup>36  AND instance LIKE '%prd%' FACET instance,HoursSinceLastBackup,hostname"
    warning                         = false
    critical                        = true
    critical_operator               = "above_or_equals"
    critical_threshold              = 1
  ...
  "5" = {
    ...
    aggregation_delay             = 120
    baseline_direction            = "upper_only"
    query                         = "FROM MssqlCustomQuerySample SELECT uniqueCount(LogBackupStatus) WHERE LogBackupStatus LIKE '%Log Backup Outdated%' AND label.query=logbackup AND instance LIKE '%prd%' FACET LogBackupStatus,instance,hostname,DatabaseName"
    warning                       = true
    critical                      = false
    warning_operator              = "above_or_equals"
    warning_threshold             = 1
  ...
  "6" = {
    ...
    aggregation_delay               = 120
    baseline_direction              = "upper_only"
    query                           = "FROM MssqlCustomQuerySample SELECT uniqueCount(LogBackupStatus) WHERE LogBackupStatus LIKE '%No Log Backup%' AND label.query=logbackup AND instance LIKE '%prd%' FACET LogBackupStatus,instance,hostname,DatabaseName "
    warning                         = false
    critical                        = true
    critical_operator               = "above_or_equals"
    critical_threshold              = 1
  ...
  "7" = {
    ...
    aggregation_delay               = 120
    baseline_direction              = "upper_only"
    query                           = "FROM MssqlCustomQuerySample SELECT uniqueCount(BlockingSessionID) WHERE label.query='blocked' AND BlockingSessionID!=0 AND instance LIKE '%prd%' FACET instance,hostname,wait_resource,BlockingSessionID"
    warning                         = false
    critical                        = true
    critical_operator               = "above_or_equals"
    critical_threshold              = 1
  ...
  "8" = {
    ...
    aggregation_delay               = 120
    baseline_direction              = "upper_only"
    query                           = "FROM MssqlCustomQuerySample SELECT  uniquecount(DatabaseStatus) WHERE label.query='dbstate'  WHERE DatabaseStatus!='ONLINE' AND instance LIKE '%prd%' FACET DatabaseName,instance,DatabaseStatus"
    warning                         = false
    critical                        = true
    critical_operator               = "above_or_equals"
    critical_threshold              = 1
  ...
  "10" = {
    ...
    aggregation_delay               = 120
    baseline_direction              = "upper_only"
    query                           = "FROM MssqlCustomQuerySample  SELECT  uniqueCount(SynchronizationHealth) WHERE label.query='replica' WHERE SynchronizationHealth!='HEALTHY' AND instance LIKE '%prd%' FACET SynchronizationHealth,instance,hostname"
    warning                         = false
    critical                        = true
    critical_operator               = "above_or_equals"
    critical_threshold              = 1
  ...
  "11" = {
    ...
    aggregation_delay               = 120
    baseline_direction              = "upper_only"
    query                           = "FROM MssqlCustomQuerySample  SELECT uniqueCount(DatabaseState) WHERE label.query='agonline' WHERE DatabaseState!='ONLINE' AND instance LIKE '%prd%' FACET instance,hostname,DatabaseState"
    warning                         = false
    critical                        = true
    critical_operator               = "above_or_equals"
    critical_threshold              = 1
